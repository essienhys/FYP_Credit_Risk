...
with col2:
    ...
    st.markdown('<p class = "subheader">Developed by: Heng Yi Sheng (TP048930) <br>Supervised by: Dr. Preethi Subramanian <br>2nd Marker: Assoc. Prof. Dr. Sivakumar Vengusamy</p>', unsafe_allow_html = True)
