...
st.markdown('<style>.subheader{text-align: center; font-family:Verdana; color:Green; font-size: 20px;}</style>', unsafe_allow_html = True)

image = Image.open('APU Logo.png') # APU Logo
col1, mid, col2 = st.columns([5, 5, 20])
with col1:
